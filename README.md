...
<br>
そこで今回は、MVVMアーキテクチャやリアクティブプログラミングに沿った開発、SwiftUIによるUI構築などを、実際にアプリを作りながら学びたいと思い当アプリの開発を決めました。
<br>
...
<br>
今回は学習を目的として開発を行いました。非常に小規模なプロジェクトでしたが、SwiftUIベースで開発のメリデメや、学習前は全くイメージできなかったリアクティブプログラミングを体験できたのでとても良い勉強になりました。
<br>
これからも引き続き頑張ります。
